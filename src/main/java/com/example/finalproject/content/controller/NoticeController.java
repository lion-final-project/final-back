...
public class NoticeController {
    ...
    public ResponseEntity<ApiResponse<PostNoticeCreateResponse>> createNotice(
            ...
            User user) {
        PostNoticeCreateResponse response = noticeService.createNotice(request, user);
    ...
    public ResponseEntity<ApiResponse<PatchNoticeUpdateResponse>> updateNotice(
            ...
            User user) {
        PatchNoticeUpdateResponse response = noticeService.updateNotice(noticeId, request, user);
        return ResponseEntity.ok(ApiResponse.success(response));
    }
