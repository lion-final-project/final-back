...
public interface StoreOrderRepository extends JpaRepository<StoreOrder, Long> {
    ...
    List<StoreOrder> findByStoreIdAndStatusIn(@Param("storeId") Long storeId, @Param("statuses") List<StoreOrderStatus> statuses);
    ...
    List<StoreOrder> findCompletedByStoreIdAndStatusIn(@Param("storeId") Long storeId, @Param("statuses") List<StoreOrderStatus> statuses);
